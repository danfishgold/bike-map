...
“(cycleway=lane and cycleway=track) or (highway=cycleway) or (highway=footway and highway=path and (bicycle=yes or bicycle=designated or bicycle=official))”
*/
[out:json][timeout:25];
// gather results
(
  // query part for: “cycleway=lane and cycleway=track”
  node["cycleway"="lane"]["cycleway"="track"]({{bbox}});
  way["cycleway"="lane"]["cycleway"="track"]({{bbox}});
  relation["cycleway"="lane"]["cycleway"="track"]({{bbox}});
